...
<body>
    <div class="container">
        <div class="row text-center">
            ...
            <h5><a href="${pageContext.request.contextPath}/addProduct.jsp">Add Product</a> </h5>
            ...
            <table class="table table-striped">
                ...
                <c:forEach var="product" items="${productList}">
                 <tr>
                    ...
                    <c:param name="productName" value="${product.name}"></c:param>
                    <c:param name="productPrice" value="${product.price}"></c:param>
                    <c:param name="productCategory" value="${product.category}"></c:param>                    
                    </c:url>
                    <td><a href="${editUrl}">Edit</a></td>
                    
                    
                    <c:url var="deleteUrl" value="/ProductDelete">
                    <c:param name="productId" value="${product.id}"></c:param>
                    </c:url>
